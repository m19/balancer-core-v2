...
contract MerkleRedeem is IDistributor, Ownable {
    ...
    function claimWeek(
        ...
        require(verifyClaim(liquidityProvider, week, claimedBalance, _merkleProof), "Incorrect merkle proof");
    ...
    function verifyClaim(
        ...
        return MerkleProof.verify(_merkleProof, weekMerkleRoots[week], leaf);
    }
